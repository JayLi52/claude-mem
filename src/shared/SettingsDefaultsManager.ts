...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_DASHSCOPE_EMBEDDING_API_KEY: string;
  CLAUDE_MEM_DASHSCOPE_EMBEDDING_MODEL: string;
  CLAUDE_MEM_DASHSCOPE_EMBEDDING_BASE_URL: string;
  CLAUDE_MEM_DASHSCOPE_EMBEDDING_DIMENSIONS: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_DASHSCOPE_EMBEDDING_API_KEY: '',
    CLAUDE_MEM_DASHSCOPE_EMBEDDING_MODEL: 'qwen3.7-text-embedding',
    CLAUDE_MEM_DASHSCOPE_EMBEDDING_BASE_URL: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
    CLAUDE_MEM_DASHSCOPE_EMBEDDING_DIMENSIONS: '1024',
